...
class _ListSentencesState extends State<ListSentences> {
  SentencePaginationSerializer _sentencePagen = SentencePaginationSerializer();
      ...
      children: [
        ...
        DropdownButton(
          ...
          onChanged: (v) {
            ...
            _sentencePagen.filter.type = index == 0 ? null : index - 1;
        ...
        DropdownButton(
          ...
          onChanged: (v) {
            _sentencePagen.filter.tag__icontains = v != _tagOptions.first ? v : null;
        ...
        DropdownButton(
          ...
          onChanged: (v) {
            _sentencePagen.filter.tense = v != _tenseOptions.first ? v : null;
        ...
        DropdownButton(
          ...
          onChanged: (v) {
            _sentencePagen.filter.pattern__icontains = v != _formOptions.first ? v : null;
        ...
        TextButton(
          ...
          onPressed: () async {
            ...
            if(s != null) {
              ...
              if(ret) {
                var find = _sentencePagen.results.where((e) => e.id == s.id);
                if(find.isEmpty) _sentencePagen.results.add(s);
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            maxLines: null,
            onChanged: (v) {
              _sentencePagen.filter.en__icontains = v.trim().isNotEmpty ? v.trim() : null;
            },
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () async {
                  bool ret = await _sentencePagen.retrieve();
                  if(ret) setState((){});
                },
              ),
            ),
  ...
  Widget _buildListSentences(BuildContext context) =>
    Container(
      ...
      child: Pagination(
        pages: (_sentencePagen.count / _sentencePagen.queryset.page_size).ceil(),
        curPage: _sentencePagen.queryset.page_index,
        goto: (num index) async {
          _sentencePagen.queryset.page_index = index;
          bool ret = await _sentencePagen.retrieve();
          if(ret) setState((){});
        },
        perPage: _sentencePagen.queryset.page_size,
        perPageSet: [10, 20, 30, 50],
        perPageChange: (v) async {
          _sentencePagen.queryset.page_index = 1;
          _sentencePagen.queryset.page_size = v;
          bool ret = await _sentencePagen.retrieve();
          if(ret) setState((){});
        },
        rows: _sentencePagen.results.map<Widget>((e) => 
          sentenceItem(
            context: context,
            sentence: e,
            trailing: Row(
              ...
              children: [
                ...
                EditDelete(
                  ...
                  delete: () {
                    e.delete();
                    _sentencePagen.results.remove(e);
                    setState(() {});
                  },
                ),
              ]

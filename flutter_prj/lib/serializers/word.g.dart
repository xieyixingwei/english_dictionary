...
WordSerializer _$WordSerializerFromJson(Map<String, dynamic> json) {
  return WordSerializer()
    ...
    ..w_partofspeech = json['w_partofspeech'] == null
        ? null
        : json['w_partofspeech'].map<PartOfSpeechSerializer>((e) => e as PartOfSpeechSerializer).toList()
    ..w_sentence_pattern = json['w_sentence_pattern'] == null
        ? null
        : json['w_sentence_pattern'].map<SentencePatternSerializer>((e) => e as SentencePatternSerializer).toList()
    ..w_word_collocation = json['w_word_collocation'] == null
        ? null
        : json['w_word_collocation'].map<WordCollocationSerializer>((e) => e as WordCollocationSerializer).toList();
}
